            ...
            <div class="box-body">
                ...
                <div class="col-md-4 satir">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control fiyat hesaplama" name="price" id="para"  value="<?php echo $item->price;?>" placeholder="Lütfen Eklemek İstediğini Ürünün Fiyatını Giriniz">
                        <?php if (isset($form_error)){ ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control iskonto hesaplama" name="discounted_rate"   value="<?php echo $item->discounted_rate;?>"  placeholder="Lütfen Eklemek İstediğini İndirim Oranını Giriniz">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">İndirimli Fiyatı</label>
                        <input type="text" class="form-control satisfiyati" value="<?php echo $item->discounted_price;?>" name="discounted_price">
                    </div>
